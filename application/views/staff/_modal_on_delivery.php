    <div class="modal-on-delivery">
        <div class="modal-wrapper">
            <i class="bx bx-x closeModal" id="toggleCloseOnDelivery"></i>

            <h4 class="text-primary">set request as On Delivery</h4>
            ...
            <form id="formOnDelivery" action="#" method="POST">
                ...
                <div class="form-action-buttons">
                    <button class="btn btn-primary px-4 btnSendDocument" id="btnOnDelivery" type="submit">On Delivery</button>
                </div>
            </form>
        </div>
    </div>