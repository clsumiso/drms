    ...
    <input type="text" class="form-control d-none" id="navID" value="7">
    ...
    <ul>
        ...
        <li>
            <a href="<?php echo base_url('admin/handlers'); ?>">
        ...
        <li>
            <a class="active" href="<?php echo base_url('admin/maintenance'); ?>">
