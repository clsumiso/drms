$(document).ready(function() {
    ...
    $(document).on('change', '.getDocument', function() {
        ...
        if ($(this).val() == 1) {
            ...
            $(this).parent().parent().parent().find('.getFType').val('10')
        } else if ($(this).val() == 8) {
            $(this).parent().parent().parent().find('.getFType').val('11')
        } else if ($(this).val() == 9) {
            $(this).parent().parent().parent().find('.getFType').val('12')
        } else if ($(this).val() == 10) {
            $(this).parent().parent().parent().find('.getFType').val('13')
        } else if ($(this).val() == 11) {
            $(this).parent().parent().parent().find('.getFType').val('19')
        } else if ($(this).val() == 12) {
